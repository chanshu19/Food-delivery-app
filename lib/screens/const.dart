...
List<Restaurants> restaurantList = [
  Restaurants(
      key: ['vikash hotel', 'vikash', 'rasgulla', 'rajbhog'],
      title: "Vikash Hotel",
  ...
  Restaurants(
    key: ['shyam chaat', 'shyam cha', 'syam chat', 'shyam chat'],
    title: "Shyam Chaat & Chowmein",
  ...
  Restaurants(
    key: ['tinku thela', 'tinku', 'launlatta'],
    title: "Tinku Samosa",
    locations: "Samosa, Fast Food, Launglatta",
    price: "10",
    rating: "4.1",
    imageUrl:
  ...
  Restaurants(
    key: ["upendra", "singhara", "jalebi"],
    title: "Upendra Halwai",
